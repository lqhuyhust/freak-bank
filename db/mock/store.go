...
// Source: freak-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) AddAccountBalance(arg0 context.Context, arg1 sqlc.AddAccountBalanceParams) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccount(arg0 context.Context, arg1 sqlc.UpdateAccountParams) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateEntry(arg0 context.Context, arg1 sqlc.UpdateEntryParams) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateTransfer(arg0 context.Context, arg1 sqlc.UpdateTransferParams) error {
	m.ctrl.T.Helper()
